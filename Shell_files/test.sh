...
echo "*******************************"
./Tests/Executable_files/main -r ${DEFAULT_USER_PORT} -m ${DEFAULT_CONN_NUM} -t 1000 -u 0 -pnabs -c ~/Desktop/scripts/certificate_test/certificate.crt -k ~/Desktop/scripts/certificate_test/private.key
